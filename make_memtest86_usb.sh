...
"${SCRIPT_DIR}/utils/prepare_usb_for_memtest86_uefi_booting.sh" "${DISK_NAME}"
"${SCRIPT_DIR}/utils/install_memtest86_to_prepared_usb.sh" "${DISK_NAME}" "${ALREADY_DOWNLOADED_MEMTEST86_ISO}"
...
echo
echo "Links to the complete memtest86 install script"
